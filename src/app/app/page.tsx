    ...
    return <>
        <main className={styles.dashboardMain}>
            ...
            <div className={styles.mainContainer}>
                ...
                <a href="https://discord.com/oauth2/authorize?client_id=1111870769027371094&permissions=8&integration_type=0&scope=bot+applications.commands"
                   target="_blank" className={styles.addBot}>
